...
function foundry_navigation_bar() {
	...
	$('#stacks_in_4_2 .navigation_bar .navigation_container ul').find("> li").each(function() {
		...
		$('html').click(function() {
			$('#stacks_in_4_2 .navigation_bar .navigation_container ul > li > a').addClass('closed').removeClass('open');
			$('#stacks_in_4_2 .navigation_bar .navigation_container ul > li > ul').stop(true, true).slideUp(200);
		});
	
		$('#stacks_in_4_2').click(function(event){
