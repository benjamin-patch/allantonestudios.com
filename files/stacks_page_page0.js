...
function foundry_navigation_bar() {
	...
	$('#stacks_in_233 .navigation_bar ').parentsUntil('.stacks_top').css({'overflow' : 'visible'});
	$('.stacks_top').css({'overflow' : 'visible'});

	// Unwraps the link from dividers and small subheaders
	$('#stacks_in_233 .navigation_bar div.nav_divider, #stacks_in_233 .navigation_bar .small_hdr').unwrap();



	// Removes href attributes from parent navigation links.
	// This could be offered as an option possibly.
	// $('#stacks_in_233 .navigation_bar .navigation_container > ul > li > a.parent').removeAttr("href").addClass('closed');

	$('#stacks_in_233 .navigation_bar .navigation_container > ul > li > a.parent').attr("href", "#").addClass('closed');
	...
	//
	$('#stacks_in_233 .navigation_bar .navigation_container ul').find("> li").each(function() {
			if ($(this).find("ul:first").length > 0) {
					...
					$(this).find('> a.parent').click(function() {
						...
						event.preventDefault();
							...
							//
							$("#stacks_in_233 .navigation_bar .navigation_container ul li").removeClass('clicked');

							$(this).parent().addClass('clicked');

							$("#stacks_in_233 .navigation_bar .navigation_container ul li:not(.clicked) a.open").parent().find('ul:first').stop(true, true).slideUp(200);


							$("#stacks_in_233 .navigation_bar .navigation_container ul li").find("> a").addClass('closed').removeClass('open');
		...
		$('html').click(function() {
			$('#stacks_in_233 .navigation_bar .navigation_container ul > li > a').addClass('closed').removeClass('open');
			$('#stacks_in_233 .navigation_bar .navigation_container ul > li > ul').stop(true, true).slideUp(200);
		});
	
		$('#stacks_in_233').click(function(event){
	...
	//
	$('#stacks_in_233_mobile_navigation_toggle').click(function(){
		$('#stacks_in_233 .navigation_bar .navigation_container > ul').slideToggle(175, function(){});
	});
	...
	function stickIt() {
		$("#stacks_in_233 .navigation_bar").sticky({
			topSpacing: 0,
			bottomSpacing: 0,
			className: 'is-sticky',
			wrapperClassName: 'sticky-wrapper',
	...
	function stickItUpdate() {
		$("#stacks_in_233 .navigation_bar").sticky('update');
	}

	$(window).load(function(){
		foundry_navigation_bar();

		if ($('#stacks_in_233 .navigation_bar').length){
			var navTop = $("#stacks_in_233 .navigation_bar").offset().top;

			if (navTop > 0) {
				stickIt();
			} else {
				$("#stacks_in_233 .navigation_bar").addClass('sticky simple-sticky');
			}	
		}
	});
